...
let superHeroArray = [superman, batman, aquaman, wonderwoman, ironman, spiderman, antman, venom, flash, joker, greenlantern, greenarrow, captainamerica, doctorstrange, thor, loki, deadpool, hulk]
